...
class mlq4stModel:
    ...
    def __init__(
        ...
        coords: np.ndarray,
        *,
        config: Optional[mlq4stConfig] = None,
        ...
        cfg = mlq4stConfig() if config is None else config
    ...
    # Fit
    # ---------------------------------------------------------------------
    def fit(self, *, X_cov: np.ndarray, Y_obs: np.ndarray, dates: Sequence[Any]) -> "mlq4stModel":
        """
